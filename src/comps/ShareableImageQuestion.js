...
const ShareableImageQuestion = ({text,question}) => {
     ...
     <View style={{
      ...
      //  width:400,
        ...
        <View style={{width:135,flexDirection:"column",justifyContent:"space-between",height:275}}>
          <Text style={{fontSize:18,color:"black",fontFamily:"Notoregular",textDecorationLine:"underline",width:130,marginTop:40,opacity:0.6}}>{question}</Text>
